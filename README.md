...
This C script is intended for usage with [ankiutils](https://github.com/abdnh/ankiutils) to work around Windows permission issues while updating add-ons that depend on C extension modules.
